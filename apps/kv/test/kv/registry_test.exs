defmodule KV.RegistryTest do
  ...
  test "Creates a bucket with a name", %{registry: registry} do
    assert KV.Registry.lookup(registry, "house") == :error
    KV.Registry.create(registry, "house")

    {:ok, bucket} = KV.Registry.lookup(registry, "house")
